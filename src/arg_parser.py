...
def base_parser(parent_parser):
    ...
    subparser.add_argument('--query_strategy_function', type=str, default='random_query', choices=['random_query', 'prediction_entropy_query', 'breaking_ties_query', 'least_confidence_query', 'breaking_ties_bernoulli_query'])
    ...
    subparser.add_argument('--output_dir', type=str, default='./outputs')
    ...
    subparser.add_argument('--metrics_name', type=str, default='compute_metrics', choices=['compute_metrics', 'compute_metrics_fewnerd'])
    ...
    subparser.add_argument('--initial_dataset_selection_strategy', type=str, default='random_initial_dataset_sampling', choices=['random_initial_dataset_sampling', 'tfidf_initial_dataset_sampling', 'longest_sentences_dataset_sampling', 'tfidf_kmeans_initial_dataset_sampling', 'tfidf_probabilistic_initial_dataset_sampling', 'tfidf_most_dissimilar_initial_dataset_sampling', 'supervised_initial_dataset_sampling', 'tfidf_avoiding_duplicates_initial_dataset_sampling', 'supervised_avoid_duplicates_initial_dataset_sampling', 'static_initial_dataset_sampling', 'nnp_frequency_initial_dataset_sampling', 'nnp_filter_initial_dataset_sampling', 'models_breaking_ties_lm_predictions_dataset_sampling'])
    ...
    subparser.add_argument('--stop_words', type=str, default=None, help='Parameter for initial_dataset_strategy')
